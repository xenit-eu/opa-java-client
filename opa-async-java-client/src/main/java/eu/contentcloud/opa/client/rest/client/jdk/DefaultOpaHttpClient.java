package eu.contentcloud.opa.client.rest.client.jdk;

import com.fasterxml.jackson.databind.ObjectMapper;
import eu.contentcloud.opa.client.rest.client.jdk.converter.ConverterProcessor;
import eu.contentcloud.opa.client.rest.client.jdk.converter.HttpBodyConverter.DeserializationContext;
import eu.contentcloud.opa.client.rest.client.jdk.converter.HttpBodyConverter.SerializationContext;
import eu.contentcloud.opa.client.rest.client.jdk.converter.JacksonBodyConverter;
import eu.contentcloud.opa.client.rest.client.jdk.converter.StringConverter;
import eu.contentcloud.opa.client.rest.OpaHttpClient;
import eu.contentcloud.opa.client.rest.http.HttpMethod;
import eu.contentcloud.opa.client.rest.http.HttpRequestHeaders;
