...
public class MediaType {
     ...
     *
     * For example, {@code text/*} should includes {@code text/plain} and {@code text/html},
    ...
    /**
     * Return a string representation of the given list of {@code MediaType} objects, to be used in an
     * {@code Accept} or {@code Content-Type} header.
     *
